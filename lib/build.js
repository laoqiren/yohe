...
module.exports = function(dir,options){
    ...
    splitPages(list,config.theme.per_page,'index','index',path.resolve(themeDir,'layout','index.html'),outputDir,{
        tags,
        categories,
        config
    },true);
    ...
    // 渲染tags页
    renderTagsCates(dir,outputDir,'tags',{
        tags,
        categories,
        config
    });
    ...
    // 渲染categories页
    renderTagsCates(dir,outputDir,'categories',{
        tags,
        categories,
        config
    });
